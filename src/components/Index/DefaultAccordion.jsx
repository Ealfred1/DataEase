  ...
  return (
    ...
    <div>
      ...
      <Accordion open={open === 1} className="border rounded-lg shadow-md mb-4">
        <AccordionHeader
          className="flex items-center justify-between text-lg font-medium bg-blue-50 p-4 hover:bg-blue-100"
          onClick={() => handleOpen(1)}
        >
          <div className="flex items-center">
            <i className='bx bx-question-mark text-blue-600 text-2xl'></i>
            <span className="ml-2">Charge free funding</span>
          </div>
          {/* <i className={`bx bx-chevron-down text-blue-600 text-2xl transition-transform duration-300 ${open === 1 ? "rotate-180" : ""}`}></i> */}
        </AccordionHeader>
      ...
      <Accordion open={open === 2} className="border rounded-lg shadow-md mb-4">
        ...
        >
          <div className="flex items-center">
            <i className='bx bx-book text-blue-600 text-2xl'></i>
            <span className="ml-2">We are 100% reliable</span>
          </div>
          {/* <i className={`bx bx-chevron-down text-blue-600 text-2xl transition-transform duration-300 ${open === 2 ? "rotate-180" : ""}`}></i> */}
        </AccordionHeader>
        <AccordionBody className="p-4 bg-white">
      ...
      <Accordion open={open === 3} className="border rounded-lg shadow-md mb-4">
        ...
        >
          <div className="flex items-center">
            <i className='bx bx-bulb text-blue-600 text-2xl'></i>
            <span className="ml-2">We are automated</span>
          </div>
          {/* <i className={`bx bx-chevron-down text-blue-600 text-2xl transition-transform duration-300 ${open === 3 ? "rotate-180" : ""}`}></i> */}
        </AccordionHeader>
        <AccordionBody className="p-4 bg-white">
